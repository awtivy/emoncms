...
<script language="javascript" type="text/javascript" src="<?php echo $path;?>Modules/vis/visualisations/common/vis.helper.js"></script>
    ...
    function plot(){
      $.plot(graph,[{data: data, color: plotColour}],
      {
        ...
        lines: { fill: true },
        series: { shadowSize: 0 },
        xaxis: { show: false, tickLength:10, mode: "time", timezone: "browser", min: start, max: end },
		yaxis: { ticks: [[0,"0 kW"],[5000, "5 kW"],[10000, "10 kW"],[15000, "15 kW"],[20000, "20 kW"]]},
		grid: {show: false, color: null, backgroundColor: null, clickable: false, hoverable: false, autoHighlight: false, borderWidth: 0},
